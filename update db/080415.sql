...
insert  into `tbl_jabatan`(`id_jabatan`,`jabatan`,`lembaga_id`) values (1,'Superadmins',1);
...
CREATE TABLE `tbl_vendor` (
  ...
  `telp1_vendor` varchar(30) NOT NULL,
  `telp2_vendor` varchar(30) DEFAULT NULL,
